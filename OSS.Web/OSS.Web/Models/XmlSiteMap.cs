...
namespace OSS.Web.Models
{
    public class XmlSiteMap
    {
        ...
        {
            var filePath = MapPath(physicalPath);
        ...
        private static void PopulateNode(SiteMapNode siteMapNode, XmlNode xmlNode)
        {
            ...
            if (!string.IsNullOrEmpty(controllerName) && !string.IsNullOrEmpty(actionName))
            {
                ...
                ////apply admin area as described here - https://www.snb.ca/boards/t/20478/broken-menus-in-admin-area-whilst-trying-to-make-a-plugin-admin-page.aspx
                //siteMapNode.RouteValues = new RouteValueDictionary { { "area", AreaNames.Admin } };
                siteMapNode.RouteValues = new RouteValueDictionary { { "area", "" } };
            }
