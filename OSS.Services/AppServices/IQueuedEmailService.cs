...
namespace OSS.Services.AppServices
{
    ...
    public interface IQueuedEmailService
    {
        ...
        Task InsertQueuedEmailAsync(QueuedEmailModel model);
        ...
        /// <param name="queuedEmail">Queued email</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        Task UpdateQueuedEmailAsync(QueuedEmailModel model);
        ...
        /// <param name="queuedEmail">Queued email</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        Task DeleteQueuedEmailAsync(QueuedEmailModel model);
        ...
        /// </returns>
        Task<QueuedEmailModel> GetQueuedEmailByIdAsync(string encryptedId);
        ...
        /// </returns>
        Task<IList<QueuedEmailModel>> GetQueuedEmailsByIdsAsync(string[] Ids);
        ...
        /// The task result contains the queued emails
        /// </returns>
        Task<IPagedList<QueuedEmailModel>> SearchEmailsAsync(string fromEmail,
